...
urlpatterns = [
    ...
    path("professores/exportar/", views.exportar_professores_csv, name="exportar_professores_csv"),
    path("professores/exportar/excel/", views.exportar_professores_excel, name="exportar_professores_excel"),
    path("professores/exportar/pdf/", views.exportar_professores_pdf, name="exportar_professores_pdf"),
